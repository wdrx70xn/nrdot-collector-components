module github.com/newrelic/nrdot-collector-components/receiver/postgresqlreceiver
...
replace github.com/newrelic/nrdot-collector-components/internal/sqlquery => ../../internal/sqlquery
